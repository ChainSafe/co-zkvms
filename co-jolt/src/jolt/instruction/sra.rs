...
impl<F: JoltField, const WORD_SIZE: usize> JoltInstruction<F> for SRAInstruction<WORD_SIZE> {
...
impl<F: JoltField, const WORD_SIZE: usize> Rep3JoltInstruction<F> for SRAInstruction<WORD_SIZE> {
